...
const char * date_wrong_day_number::what() const throw()
{
	return "date_wrong_day_number";
}

const char * date_wrong_month_number::what() const throw()
{
	return "date_wrong_month_number";
}

const char * date_wrong_year_number::what() const throw()
{
